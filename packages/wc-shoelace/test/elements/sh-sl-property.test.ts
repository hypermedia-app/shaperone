...
describe('wc-shoelace/elements/sh-sl-property', function () {
  it('renders a slot for "add object" control', async function () {
    // given
  ...
  it('does not render a slot for "add object" control when flag is not set', async function () {
    // when
