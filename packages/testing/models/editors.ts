...
import type { matchMultiEditors, matchSingleEditors } from '@shaperone/core/models/editors/lib/match.js'
import type { EditorsState, MultiEditor, SingleEditor, MatcherDecorator, Editor } from '@shaperone/core/models/editors'
