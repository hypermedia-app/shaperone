...
In the case of `shaperone`, components are rendered by `lit-html`
...
[Shaperone for Web Components](https://npm.im/shaperone) comes with a number of such sets:

1. Browser native elements, which are available out of the box with the `shaperone-form` custom element
3. [Sholaces](https://shoelace.style/) elements provided by [@shaperone/shoelace](https://npm.im/@shaperone/shoelace)
3. [Vaadin Components](https://vaadin.com/components/) provided by [@shaperone/vaadin](https://npm.im/@shaperone/vaadin)
